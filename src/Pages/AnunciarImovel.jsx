...
export default function AnunciarImovel() {
  ...
  const telefone = user?.prefs?.telefone;
  ...
  useEffect(() => {
    if (anuncioParaEditar) {
      ...
      setFormData({
        ...
        tipoImovel: anuncioParaEditar.tipoImovel === 'casa' ? 'Casa' : 
                    anuncioParaEditar.tipoImovel === 'apartamento' ? 'Apartamento' :
                    anuncioParaEditar.tipoImovel === 'terreno' ? 'Terreno' : 'Casa',
